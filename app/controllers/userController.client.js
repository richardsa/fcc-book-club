...
(function() {
                ...
                for (var i = 0; i < response.length; i++) {
                    ...
                    if (response[i].ownerId === profId && (response[i].requestorId === "" || response[i].approvalStatus === "N")) {
                        output += '<div class="btn removeBtn ' + bookId + '" id="' + bookId + '" ><p>Remove Book</p></div>';
                          ...
                          output += '<div class="btn requestedButton ' + bookId + '"><p>Request Approved</p></div>';
    ...
    output += "</div>"; console.log(output); allBooks.innerHTML = output;
}
...
$("#requestedBooks").on("click", ".requestedButton", function() {
    var requestUrl = $(this).attr('id');
